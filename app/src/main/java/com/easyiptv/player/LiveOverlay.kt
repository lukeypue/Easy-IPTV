...
object LiveOverlay {
    ...
    /** X1-style repeated transport presses: 2x, 4x, 8x, 16x, then cycle to normal. */
    ...
    fun centeredWindow(currentIndex: Int, itemCount: Int): IntRange {
        ...
        val start = (current - 1).coerceAtLeast(0).coerceAtMost((itemCount - visibleRowCount).coerceAtLeast(0))
