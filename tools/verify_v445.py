...
checks = {
    ...
    'full v4.24 fluid navigation restored': 'onBackToRoot()' in main and 'externalFocus.requestFocus()' in main,
    'three-row mini guide restored': 'only 3 rows stay on screen' in main and 'height(66.dp)' in main,
